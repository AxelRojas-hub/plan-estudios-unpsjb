...
const licenciaturaInformatica: Carrera = {
    ...
    materias: [
        ...
        { codigo: "IF006", nombre: "Algorítmica y Programación II", año: 2, cuatrimestre: 1, correlativas: ["IF003"], cargaHoraria: 120 },
        ...
        { codigo: "IF010", nombre: "Análisis y Diseño de Sistemas", año: 3, cuatrimestre: 1, correlativas: ["IF007"], cargaHoraria: 135 },
        { codigo: "IF011", nombre: "Sistemas Operativos", año: 3, cuatrimestre: 1, correlativas: ["IF005"], cargaHoraria: 150 },
        { codigo: "IF012", nombre: "Desarrollo de Software", año: 3, cuatrimestre: 2, correlativas: ["IF008", "IF010"], cargaHoraria: 120 },
        { codigo: "IF013", nombre: "Fundamentos Teóricos de Informática", año: 3, cuatrimestre: 2, correlativas: ["MA008"], cargaHoraria: 120 },
        ...
        { codigo: "IF017", nombre: "Taller de Nuevas Tecnologías", año: 5, cuatrimestre: 2, correlativas: ["IF015"], cargaHoraria: 90 },
        ...
        { codigo: "IF027", nombre: "Modelos y Simulación", año: 5, cuatrimestre: 1, correlativas: ["IF009"], cargaHoraria: 90, esOptativa: true, grupoOptativa: "optativa1" },

        { codigo: "IF023", nombre: "Diseño de Aplicaciones Web", año: 5, cuatrimestre: 2, correlativas: ["IF009"], cargaHoraria: 135, esOptativa: true, grupoOptativa: "optativa2" },
